...
INSERT INTO halaman_web (kode_html) VALUES ('<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">Puzii</a></h1>
  </header><!-- End Header -->
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>fazi</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
